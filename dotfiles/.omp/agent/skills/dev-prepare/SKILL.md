---
name: dev-prepare
description: Create the exact remote review candidate, then stop.
---
...
- Push with lease protection, create/update a **draft** PR with a concise provisional body, and confirm exact pushed HEAD/PR so external checks can start.
