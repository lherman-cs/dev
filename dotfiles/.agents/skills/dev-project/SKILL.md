...
* After `wait_agent` wakes, consume the delivered child result and route it; if the required child is still running, wait again rather than returning a progress-only final response.
