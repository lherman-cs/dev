...
- A completed Reviewer without a recognized terminal verdict is a Reviewer contract failure: record it and return `BLOCKED`/`ESCALATED`; do not keep waiting or silently respawn.
