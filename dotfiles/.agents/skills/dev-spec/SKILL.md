...
## Explorer
- Use Explorer for substantial supporting discovery that could change the design. Read supplied requirements and known-path facts directly. Use the [bounded evidence handoff](../dev-project/prompts/explore-facts.md); retain judgment and inspect decision-critical anchors yourself.
