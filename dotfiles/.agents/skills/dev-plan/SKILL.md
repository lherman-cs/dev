...
9. Self-review once: coverage, dependency/interface consistency, feasibility of each task in isolation, meaningful failure/pass evidence, and unnecessary work. Resolve gaps and mark READY; no separate plan-review agent.
