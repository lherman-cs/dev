...
- If the review cannot be completed because required evidence, access, or capability is unavailable, return `BLOCKED` with the exact reason rather than terminating without a verdict.
