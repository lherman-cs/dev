...
export const waitOutcomeSchema = Type.Object({ status: Type.Union([Type.Literal("passed"), Type.Literal("failed"), Type.Literal("stale_timeout"), Type.Literal("cancelled"), Type.Literal("interrupted")]), candidate: candidateIdentitySchema, checks: Type.Array(ciCheckSchema), observedSignals: Type.Optional(Type.Array(text(500))), reason: Type.Optional(text(500)) }, { additionalProperties: false });
