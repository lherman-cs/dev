...
| --- | --- | --- |
| `@earendil-works/pi-coding-agent` | 0.86.1 | Native sessions, authentication, tools, Markdown/Mermaid and cancellation. SDK integration is exercised without live provider calls. |
