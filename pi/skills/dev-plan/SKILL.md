...
- Resolve the architecture, code touchpoints, interfaces, ownership, invariants, constraints, risks, and proof needed to make each outcome straightforward to implement without rediscovering consequential design decisions.
...
- The plan guides implementation rather than controlling it. The Builder may adapt sequencing or local mechanics when code reality demands it without changing approved semantics, resolved architecture, or required outcomes.
