...
- Use approved spec + plans/repairs, base-to-HEAD diff/history, local verification, focused CI failure logs, bot/PR feedback, tests, and verified Explorer findings.
