...
test('94d10a6 semantic contracts retain authority, outputs and stop conditions at skill scope',()=>{
  const requirements={
    ...
    build:['exactly the approved','one independently testable','Fix root causes','fast, deterministic','Do not weaken, delete, or bypass','data safety','accessibility','necessary observability','Conventional Commit','NEEDS_REPLAN'],
    ship:['Never merge','remote inspection','review evidence','explicit human confirmation','Do not invent recovery state'],
