...
pub const EXTRA_ASSETS: &[ExtraAsset] = &[
    ...
    ExtraAsset { path: "skills/dev-project/prompts/task-spec-review.md", source: include_str!("../dotfiles/.agents/skills/dev-project/prompts/task-spec-review.md") },
    ExtraAsset { path: "skills/dev-project/prompts/task-quality-review.md", source: include_str!("../dotfiles/.agents/skills/dev-project/prompts/task-quality-review.md") },
    ExtraAsset { path: "skills/dev-project/prompts/scoped-spec-rereview.md", source: include_str!("../dotfiles/.agents/skills/dev-project/prompts/scoped-spec-rereview.md") },
    ExtraAsset { path: "skills/dev-project/prompts/scoped-quality-rereview.md", source: include_str!("../dotfiles/.agents/skills/dev-project/prompts/scoped-quality-rereview.md") },
    ...
    ExtraAsset { path: "skills/dev-project/prompts/scoped-final-rereview.md", source: include_str!("../dotfiles/.agents/skills/dev-project/prompts/scoped-final-rereview.md") },
