...
enum Commands {
    ...
    /// Manage legacy shell job groups
    #[command(name = "jobs", alias = "workflow")]
    Jobs {
        #[command(subcommand)]
...
enum AgentAction {
    ...
    /// Open the Preparer role, or run /dev-prepare immediately when a prompt is given
    Prepare { prompt: Vec<String> },
...
fn main() {
    ...
    let result = match cli.command {
        ...
        Commands::Jobs { action } => cmd_workflow(action),
