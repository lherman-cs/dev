...
- Preserve symmetric `dev a <phase>` / `/dev-<phase>` dispatch. The foreground agent coordinates `/dev-ship`; do not introduce a general coordinator.
